...
enum Symbol{
    ...
    IR_MAX = 5,             //Максмальное число бит полезных данных в принимаемом с МК пакете для ИК-датчика
...
enum ID_CAN{
    ...
    ID_US_FR = 12,          //CAN-ID для переднего правого УЗ
    ID_US_FL = 15,          //CAN-ID для переднего левого УЗ
    ID_RFID = 16,           //CAN-ID для RFID-меток
};
/*
